...
import random
import math
from app3 import AdminEfficiencyPilot
...
class AddAccountPanel(QFrame):
    def __init__(self, parent=None, data=None):
        ...
        self.api_key.setPlaceholderText("選填，留空則停用 AI 作答")
        ...
        form.addRow("AI Key", self.api_key)
    ...
    def load_data(self, data):
        ...
        self.api_key.setText(data.get("ai_api_key", ""))
